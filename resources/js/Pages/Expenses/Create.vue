...
<template>
    ...
    <AuthenticatedLayout>
        <section class="py-8 md:py-16 lg:py-20 max-w-xl">
            <h1 class="text-xl md:text-2xl font-bold tracking-tighter leading-none">Add Expense</h1>

            <form @submit.prevent="submit" class="mt-8 space-y-6">
                <div>
                    <InputLabel value="Category" />
                    <Select v-model="form.expense_category_id" :options="categoryOptions" optionLabel="label" optionValue="value" placeholder="Select a category" fluid :invalid="!!form.errors.expense_category_id" />
                ...
                <div class="flex items-center gap-6 pt-4">
                    <Button type="submit" label="Save expense" :loading="form.processing" />
