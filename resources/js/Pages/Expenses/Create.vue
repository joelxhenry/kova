...
<template>
    ...
    <AuthenticatedLayout>
        <section class="py-12 md:py-20 max-w-2xl">
            <h1 class="text-3xl md:text-4xl font-bold tracking-tighter leading-none">Add Expense</h1>

            <form @submit.prevent="submit" class="mt-10 space-y-6">
                <div>
                    <InputLabel value="Category" />
                    <Select v-model="form.expense_category_id" :options="categoryOptions" optionLabel="label" optionValue="value" placeholder="Select category" fluid :invalid="!!form.errors.expense_category_id" />
                    <InputError :message="form.errors.expense_category_id" />
                </div>

                <div>
                    <InputLabel value="Description" />
                    <InputText v-model="form.description" placeholder="e.g., Laptop purchase, Fuel receipt" autofocus fluid :invalid="!!form.errors.description" />
                ...
                <div>
                    ...
                    <Textarea v-model="form.notes" rows="3" placeholder="Optional notes..." fluid :invalid="!!form.errors.notes" />
                    <InputError :message="form.errors.notes" />
                </div>

                <div class="flex items-center gap-6 pt-4">
                    <Button type="submit" label="Save expense" :loading="form.processing" text />
