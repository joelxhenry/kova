...
// Clear a category that no longer matches after switching income/expense.
watch(() => form.type, () => {
...
<template>
    ...
    <AuthenticatedLayout>
        <section class="py-8 md:py-16 lg:py-20 max-w-xl">
            <h1 class="text-xl md:text-2xl font-bold tracking-tighter leading-none">Add Transaction</h1>

            <form @submit.prevent="submit" class="mt-8 space-y-6">
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        <InputLabel value="Account" />
                        <Select v-model="form.account_id" :options="accountOptions" optionLabel="label" optionValue="value" placeholder="Select an account" fluid :invalid="!!form.errors.account_id" />
                ...
                <div class="flex items-center gap-6 pt-4">
                    <Button type="submit" label="Save transaction" :loading="form.processing" />
