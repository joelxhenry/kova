...
// Reset type-specific fields when switching to/from a transfer.
watch(() => form.type, () => {
...
<template>
    ...
    <AuthenticatedLayout>
        <section class="py-8 md:py-16 lg:py-20 max-w-xl">
            <h1 class="text-xl md:text-2xl font-bold tracking-tighter leading-none">Add Recurring Rule</h1>
            ...
            <form @submit.prevent="submit" class="mt-8 space-y-6">
                ...
                <div class="flex items-center gap-6 pt-4">
                    <Button type="submit" label="Save recurring rule" :loading="form.processing" />
