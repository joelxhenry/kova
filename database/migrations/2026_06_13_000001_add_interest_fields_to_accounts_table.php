...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('accounts', function (Blueprint $table): void {
            // Annual interest rate as a percentage (APR). Applies to credit-card /
            ...
            $table->decimal('credit_limit', 15, 2)->nullable()->after('interest_rate');
        });
    }
    ...
    {
        Schema::table('accounts', function (Blueprint $table): void {
            $table->dropColumn(['interest_rate', 'credit_limit']);
        });
    }
};
